...
/* ---------- Signaling servers (con fallback) ---------- */
const SIGNALING = [
...
export async function initSync(tripId, options = {}) {
  ...
  // Provider WebRTC — SIN la opción `awareness` (y-webrtc la crea sola)
  try {
    ...
    // Awareness (y-webrtc la crea automáticamente)
    ...
    // Seguimos sin provider: la app funciona, solo no sincroniza
  }
...
/* ============================================================
   Lifecycle · con guards defensivos
   ============================================================ */
